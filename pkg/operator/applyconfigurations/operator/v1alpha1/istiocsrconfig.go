...
// WithConfigMapNamespaceSelector sets the ConfigMapNamespaceSelector field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ConfigMapNamespaceSelector field is set to the value of the last call.
func (b *IstioCSRConfigApplyConfiguration) WithConfigMapNamespaceSelector(value string) *IstioCSRConfigApplyConfiguration {
	b.ConfigMapNamespaceSelector = &value
	return b
}
