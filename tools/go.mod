module github.com/openshift/cert-manager-operator/tools
...
// Resolve ambiguous import: cloud.google.com/go/compute v1.6.1 contained metadata as a subpackage,
// but it was later split into a separate module. Exclude the old version to use the new metadata module.
